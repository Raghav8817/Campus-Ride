            ...
            <div className="bg-black px-6 py-4 flex justify-between items-center border-b-4 border-yellow-400 shadow-xl z-50">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="font-black text-lg tracking-tight uppercase">
                        Attendance <span className="text-yellow-400">Reports</span>
                    </h1>
                </div>
            </div>
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                <div className="flex-1 p-8 overflow-y-auto">
                    <div className="flex justify-between items-end mb-8">
                        <div>
                            <h2 className="text-3xl font-black uppercase tracking-tight">Attendance Reports</h2>
                            <p className="text-gray-500 font-medium">Daily and cumulative presence metrics</p>
                        </div>
                        ...
                        <div className="divide-y divide-white/5">
                            {buses.map((bus) => (
                                <div key={bus.busId} className="grid grid-cols-5 items-center px-6 py-5 text-sm hover:bg-white/[0.02] transition-all">
                                    ...
                                    <div className="text-green-400 font-bold">{bus.presentStudents} Students</div>
                                    <div className="text-gray-400 font-medium">{bus.totalStudents} Registered</div>
                                    <div>
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-[10px] font-black">{Math.round((bus.presentStudents / (bus.totalStudents || 1)) * 100)}%</span>
                                        </div>
                                    </div>
                                    <div className="text-right">
                                        <button 
                                            onClick={() => navigate(`/bus-attendance-report/${bus.busId}`)}
